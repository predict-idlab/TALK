...
if __name__ == '__main__':
    ...
    X_train, y_train = extractor.create_dataset(3, pos, neg, jobs=4,
                                                skip_list=['https://saref.etsi.org/core/hasActivity', 'https://saref.etsi.org/core/hasTimestamp'])
    ...
    df_train = pd.DataFrame.sparse.from_spmatrix(X_train[0], index=X_train[1], columns=X_train[2])
    # print('start saving')
    df_train.to_pickle('event_ucaml_depth3_for_ml.pkl')